    ...
    <div id="main-wrapper">
        <div class="nav-header">
            <a href="<?php echo base_url(); ?>dashboard" class="brand-logo">
                <img class="" src="https://ik.imagekit.io/habitro/company/logo.png"
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    <div class="header-info">
                                        ...
                                        <p class="fs-12 mb-0"style="color: #fff"><?php echo $this->session->userdata('name'); ?> - Admin</p>
                                    </div>
                                    <i class="fa-solid fa-user fa-xl" style="color: #fff;"></i>

                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a href="www.habitro.com" target="_blank" class="dropdown-item ai-icon">
