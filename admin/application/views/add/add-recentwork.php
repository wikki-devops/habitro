    ...
    <div class="container-fluid">
        <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
            <div class="me-auto d-lg-block d-block">
                <h2 class="text-black font-w600">Add Residential Page Content</h2>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <?php echo form_open_multipart('welcome/add_recentwork/'); ?>
                            ...
                            <div class="mb-3 row align-items-center">
                                <label class="col-sm-3 col-form-label form-label">Youtube Video Link</label>
                                <div class="col-sm-9">
